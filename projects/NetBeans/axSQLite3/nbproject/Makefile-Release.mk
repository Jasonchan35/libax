...
${OBJECTDIR}/_ext/2064239478/axDBConn_SQLite3.o: ../../../src/database/axSQLite3/axDBConn_SQLite3.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/2064239478/axDBConn_SQLite3.o ../../../src/database/axSQLite3/axDBConn_SQLite3.cpp

${OBJECTDIR}/_ext/2064239478/axDBStmt_SQLite3.o: ../../../src/database/axSQLite3/axDBStmt_SQLite3.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/2064239478
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/2064239478/axDBStmt_SQLite3.o ../../../src/database/axSQLite3/axDBStmt_SQLite3.cpp
