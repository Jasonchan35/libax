...
size_t ax_strnlen( const axUChar* s, size_t len ) { return _ax_strnlen(s,len); }
...
size_t ax_strlen( const axUChar* s ) { return _ax_strlen(s); }
...
T* _ax_strrchrs( T* sz, T* chrs ) {
	...
	return NULL;
      ...
      axUChar* ax_strrchrs(       axUChar* sz, const axUChar* chrs ) { return _ax_strrchrs(sz,(axUChar*)chrs); }
...
const axUChar* ax_strrchrs( const axUChar* sz, const axUChar* chrs ) { return _ax_strrchrs(sz,chrs); }
...
int	 ax_strcasecmp ( const axUChar* s1, const axUChar* s2 ) { return _ax_strcasecmp(s1,s2); }
...
int	 ax_strncasecmp( const axUChar* s1, const axUChar* s2, size_t n ) { return _ax_strncasecmp(s1,s2,n); }
...
T* _ax_strcasechr( T* sz, T ch ) {
	...
	return NULL;
      ...
      axUChar* 	ax_strcasechr(       axUChar* sz, axUChar ch ) { return _ax_strcasechr(sz,ch); }
...
const axUChar* 	ax_strcasechr( const axUChar* sz, axUChar ch ) { return _ax_strcasechr((axUChar*)sz,ch); }
...
T* _ax_strcasestr( T* big, T* little ) {
	...
	return NULL;
      ...
      axUChar* ax_strcasestr(       axUChar* big, const axUChar* little )	{ return _ax_strcasestr(big,(axUChar*)little); }
...
const axUChar* ax_strcasestr( const axUChar* big, const axUChar* little )	{ return _ax_strcasestr(big,little); }
...
T*	_ax_strchr( T* sz, T ch ) {
	...
	return NULL;
      ...
      axUChar* ax_strchr(       axUChar* sz, axUChar ch ) { return _ax_strchr(sz,ch); }
...
const axUChar* ax_strchr( const axUChar* sz, axUChar ch ) { return _ax_strchr<const axUChar>(sz,ch); }
...
int	 ax_strcmp ( const axUChar* s1, const axUChar* s2 ) { return _ax_strcmp(s1,s2); }
...
int	 ax_strncmp( const axUChar* s1, const axUChar* s2, size_t n ) { return _ax_strncmp(s1,s2,n); }
...
axUChar* ax_strcpy( axUChar* dst, const axUChar* src ) { return _ax_strcpy(dst,src); }
...
axUChar* ax_strncpy( axUChar* dst, const axUChar* src, size_t n ) { return _ax_strncpy(dst,src,n); }
...
T* _ax_strrchr( T* sz, T ch ) {
	...
	return NULL;
      ...
      axUChar* ax_strrchr(       axUChar* sz, axUChar ch ) { return _ax_strrchr(sz,ch); }
...
const axUChar* ax_strrchr( const axUChar* sz, axUChar ch ) { return _ax_strrchr<const axUChar>(sz,ch); }
...
T* _ax_strstr( T* a, T* b ) {
	...
	return NULL;
      ...
      axUChar* ax_strstr(       axUChar* a, const axUChar* b ) { return _ax_strstr(a,(axUChar*)b); }
...
const axUChar* ax_strstr( const axUChar* a, const axUChar* b ) { return _ax_strstr(a,b); }
...
T* _ax_strrstr( T* a, T* b ) {
	...
	return NULL;
      ...
      axUChar* ax_strrstr(       axUChar* a, const axUChar* b ) { return _ax_strrstr(a,(axUChar*)b); }
...
const axUChar* ax_strrstr( const axUChar* a, const axUChar* b ) { return _ax_strrstr(a,b); }
