...
//==== 4 Param(s) ======================================
	...
	private:
		...
		public:
			...
			OBJ* obj;
			Func func;
			virtual RET call( P0 p0, P1 p1, P2 p2, P3 p3 ) { return (obj->*func)(p0, p1, p2, p3); }
		};
...
//----- Event 4----------------------------------
	...
	public:
		...
		axALWAYS_INLINE( void operator() (P0 p0, P1 p1, P2 p2, P3 p3) ) { call(p0, p1, p2, p3); }
		...
		public:
			...
			axALWAYS_INLINE( RET call( P0 p0, P1 p1, P2 p2, P3 p3 ) ) { return functor.call(); }

			void unbind	() { objRef.unref(); }
...
//==== 3 Param(s) ======================================
	...
	private:
		...
		public:
			...
			OBJ* obj;
			Func func;
			virtual RET call( P0 p0, P1 p1, P2 p2 ) { return (obj->*func)(p0, p1, p2); }
		};
...
//----- Event 3----------------------------------
	...
	public:
		...
		axALWAYS_INLINE( void operator() (P0 p0, P1 p1, P2 p2) ) { call(p0, p1, p2); }
		...
		public:
			...
			axALWAYS_INLINE( RET call( P0 p0, P1 p1, P2 p2 ) ) { return functor.call(); }
...
//==== 2 Param(s) ======================================
	...
	private:
		...
		public:
			...
			OBJ* obj;
			Func func;
			virtual RET call( P0 p0, P1 p1 ) { return (obj->*func)(p0, p1); }
		};
...
//----- Event 2----------------------------------
	...
	public:
		...
		axALWAYS_INLINE( void operator() (P0 p0, P1 p1) ) { call(p0, p1); }
		...
		public:
			...
			axALWAYS_INLINE( RET call( P0 p0, P1 p1 ) ) { return functor.call(); }
...
//==== 1 Param(s) ======================================
	...
	private:
		...
		public:
			...
			OBJ* obj;
			Func func;
			virtual RET call( P0 p0 ) { return (obj->*func)(p0); }
		};
...
//----- Event 1----------------------------------
	...
	public:
		...
		axALWAYS_INLINE( void operator() (P0 p0) ) { call(p0); }
		...
		public:
			...
			axALWAYS_INLINE( RET call( P0 p0 ) ) { return functor.call(); }
...
//==== 0 Param(s) ======================================
	...
	private:
		...
		public:
			...
			OBJ* obj;
			Func func;
			virtual RET call(  ) { return (obj->*func)(); }
		};
...
//----- Event 0----------------------------------
	...
	public:
		...
		axALWAYS_INLINE( void operator() () ) { call(); }
		...
		public:
			...
			axALWAYS_INLINE( RET call(  ) ) { return functor.call(); }
